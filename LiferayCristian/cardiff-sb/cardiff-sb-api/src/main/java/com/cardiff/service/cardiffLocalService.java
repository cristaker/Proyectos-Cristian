...
public interface cardiffLocalService
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public cardiff fetchcardiffByUuidAndGroupId(String uuid, long groupId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public cardiff getcardiffByUuidAndGroupId(String uuid, long groupId)
		throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<cardiff> getcardiffsByUuidAndCompanyId(
