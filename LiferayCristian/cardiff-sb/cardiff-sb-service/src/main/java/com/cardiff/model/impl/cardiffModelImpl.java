...
import com.cardiff.model.cardiffModel;
...
public class cardiffModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		{"uuid_", Types.VARCHAR}, {"cardiffId", Types.BIGINT},
		{"groupId", Types.BIGINT}, {"companyId", Types.BIGINT},
		{"userId", Types.BIGINT}, {"userName", Types.VARCHAR},
		{"createDate", Types.TIMESTAMP}, {"modifiedDate", Types.TIMESTAMP},
		{"defaultLocale", Types.VARCHAR},
	...
	static {
		...
		attributeGetterFunctions.put("uuid", cardiff::getUuid);
		attributeSetterBiConsumers.put(
			"uuid", (BiConsumer<cardiff, String>)cardiff::setUuid);
	...
	public void resetOriginalValues() {
		...
		cardiffModelImpl._originalUuid = cardiffModelImpl._uuid;

		cardiffModelImpl._originalGroupId = cardiffModelImpl._groupId;

		cardiffModelImpl._setOriginalGroupId = false;

		cardiffModelImpl._originalCompanyId = cardiffModelImpl._companyId;

		cardiffModelImpl._setOriginalCompanyId = false;
	...
	public CacheModel<cardiff> toCacheModel() {
		...
		cardiffCacheModel.uuid = getUuid();

		String uuid = cardiffCacheModel.uuid;

		if ((uuid != null) && (uuid.length() == 0)) {
			cardiffCacheModel.uuid = null;
		}
