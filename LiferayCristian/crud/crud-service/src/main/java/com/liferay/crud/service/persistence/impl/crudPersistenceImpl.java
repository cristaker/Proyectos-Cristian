...
package com.liferay.crud.service.persistence.impl;

import com.liferay.crud.exception.NoSuchcrudException;
import com.liferay.crud.model.crud;
import com.liferay.crud.model.impl.crudImpl;
import com.liferay.crud.model.impl.crudModelImpl;
import com.liferay.crud.service.persistence.crudPersistence;
import com.liferay.crud.service.persistence.impl.constants.ActualizacionDeDatosPersistenceConstants;
...
public class crudPersistenceImpl
	...
	/**
	 * Returns all the cruds where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	...
	public List<crud> findBynombre(
		...
		return findBynombre(
			nombre, apellido, edad, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}

	/**
	 * Returns a range of all the cruds where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	 * <p>
	...
	@Override
	public List<crud> findBynombre(
		String nombre, String apellido, String edad, int start, int end) {

		return findBynombre(nombre, apellido, edad, start, end, null);
	}

	/**
	 * Returns an ordered range of all the cruds where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to <code>QueryUtil#ALL_POS</code> will return the full result set. If <code>orderByComparator</code> is specified, then the query will include the given ORDER BY logic. If <code>orderByComparator</code> is absent, then the query will include the default ORDER BY logic from <code>crudModelImpl</code>.
	 * </p>
	...
	public List<crud> findBynombre(
		...
		return findBynombre(
			nombre, apellido, edad, start, end, orderByComparator, true);
	}
	...
	public List<crud> findBynombre(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				...
				finderArgs = new Object[] {nombre, apellido, edad};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindBynombre;
			finderArgs = new Object[] {
				nombre, apellido, edad, start, end, orderByComparator
			};
		}
		...
		if (list == null) {
			...
			boolean bindEdad = false;

			if (edad.isEmpty()) {
				sb.append(_FINDER_COLUMN_NOMBRE_EDAD_3);
			}
			else {
				bindEdad = true;

				sb.append(_FINDER_COLUMN_NOMBRE_EDAD_2);
			}
	...
	/**
	 * Returns the first crud in the ordered set where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	 * @param nombre the nombre
	 * @param apellido the apellido
	 * @param edad the edad
	...
	public crud findBynombre_First(
		...
		crud crud = fetchBynombre_First(
			nombre, apellido, edad, orderByComparator);
	...
	public crud fetchBynombre_First(
		...
		List<crud> list = findBynombre(
			nombre, apellido, edad, 0, 1, orderByComparator);
	...
	/**
	 * Returns the last crud in the ordered set where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	 * @param nombre the nombre
	 * @param apellido the apellido
	 * @param edad the edad
	...
	public crud fetchBynombre_Last(
		...
		int count = countBynombre(nombre, apellido, edad);
		...
		List<crud> list = findBynombre(
			nombre, apellido, edad, count - 1, count, orderByComparator);
	...
	/**
	 * Returns the cruds before and after the current crud in the ordered set where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	...
	public crud[] findBynombre_PrevAndNext(
			long crudId, String nombre, String apellido, String edad,
			OrderByComparator<crud> orderByComparator)
		throws NoSuchcrudException {
		...
		try {
			...
			array[0] = getBynombre_PrevAndNext(
				session, crud, nombre, apellido, edad, orderByComparator, true);

			array[1] = crud;

			array[2] = getBynombre_PrevAndNext(
				session, crud, nombre, apellido, edad, orderByComparator,
				false);
	...
	protected crud getBynombre_PrevAndNext(
		Session session, crud crud, String nombre, String apellido, String edad,
	...
	/**
	 * Removes all the cruds where nombre = &#63; and apellido = &#63; and edad = &#63; from the database.
	 *
	 * @param nombre the nombre
	 * @param apellido the apellido
	 * @param edad the edad
	 */
	@Override
	public void removeBynombre(String nombre, String apellido, String edad) {
		for (crud crud :
				findBynombre(
					nombre, apellido, edad, QueryUtil.ALL_POS,
	...
	/**
	 * Returns the number of cruds where nombre = &#63; and apellido = &#63; and edad = &#63;.
	 *
	 * @param nombre the nombre
	 * @param apellido the apellido
	 * @param edad the edad
	 ...
	 */
	@Override
	public int countBynombre(String nombre, String apellido, String edad) {
		nombre = Objects.toString(nombre, "");
		apellido = Objects.toString(apellido, "");
		edad = Objects.toString(edad, "");
		...
		Object[] finderArgs = new Object[] {nombre, apellido, edad};
	...
	private static final String _FINDER_COLUMN_NOMBRE_APELLIDO_3 =
		"(crud.apellido IS NULL OR crud.apellido = '') AND ";

	private static final String _FINDER_COLUMN_NOMBRE_EDAD_2 = "crud.edad = ?";

	private static final String _FINDER_COLUMN_NOMBRE_EDAD_3 =
		"(crud.edad IS NULL OR crud.edad = '')";
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindBynombre = new FinderPath(
			...
			crudModelImpl.EDAD_COLUMN_BITMASK);
	...
	public void setConfiguration(Configuration configuration) {
		...
		_columnBitmaskEnabled = GetterUtil.getBoolean(
			configuration.get(
				"value.object.column.bitmask.enabled.com.liferay.crud.model.crud"),
			true);
	}
