...
package com.liferay.crud.service.persistence;
...
public class crudUtil {
	...
	public static List<crud> findBynombre(
		...
		return getPersistence().findBynombre(nombre, apellido, edad);
	}
	...
	public static List<crud> findBynombre(
		...
		return getPersistence().findBynombre(
			nombre, apellido, edad, start, end);
	}
	...
	public static crud findBynombre_First(
			String nombre, String apellido, String edad,
			OrderByComparator<crud> orderByComparator)
		throws com.liferay.crud.exception.NoSuchcrudException {
	...
	public static crud[] findBynombre_PrevAndNext(
		...
		return getPersistence().findBynombre_PrevAndNext(
			crudId, nombre, apellido, edad, orderByComparator);
	}
	 ...
	 * @param edad the edad
	 */
	public static void removeBynombre(
		String nombre, String apellido, String edad) {

		getPersistence().removeBynombre(nombre, apellido, edad);
	}
	 ...
	 */
	public static int countBynombre(
		String nombre, String apellido, String edad) {

		return getPersistence().countBynombre(nombre, apellido, edad);
	}
